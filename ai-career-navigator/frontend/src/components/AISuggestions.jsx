      ...
      <div className="relative z-10">
        ...
        <div className="flex border-b border-slate-200 bg-white overflow-x-auto">
          <button 
            ...
            className={`flex-1 min-w-32 py-3.5 text-sm font-bold transition-all duration-300 ${activeTab === 'skills' ? 'text-indigo-700 border-b-2 border-indigo-600 bg-indigo-50' : 'text-slate-500 hover:text-slate-800 hover:bg-white'}`}
          >
            Skills to Learn
          </button>
          <button 
            onClick={() => setActiveTab('projects')}
            className={`flex-1 min-w-32 py-3.5 text-sm font-bold transition-all duration-300 ${activeTab === 'projects' ? 'text-teal-700 border-b-2 border-teal-600 bg-teal-50' : 'text-slate-500 hover:text-slate-800 hover:bg-white'}`}
          >
            Project Ideas
          </button>
          <button 
            onClick={() => setActiveTab('resume')}
            className={`flex-1 min-w-32 py-3.5 text-sm font-bold transition-all duration-300 ${activeTab === 'resume' ? 'text-emerald-700 border-b-2 border-emerald-600 bg-emerald-50' : 'text-slate-500 hover:text-slate-800 hover:bg-white'}`}
          >
            Resume Tips
          </button>
        </div>
